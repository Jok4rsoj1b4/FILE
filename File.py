...
model2 = requests.get('https://github.com/Jok4rsoj1b4/FILE/blob/main/Aprov.txt').text.splitlines()
totaldmp = 0
count = 0
loop = 0
oks = []
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Jok4rsoj1b4/FILE/blob/main/Aprov.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/qr/01609859866?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
